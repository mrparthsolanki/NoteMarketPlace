...
<body>
      ...
      <h3 id="heading-add-Country">Add Category</h3>  
    <br/>
  <div class="container"> 
    <form>
    <row>
      ...
      <input type="text" class="form-control" id="f-name-1"  value="India"  placeholder="Enter Category Name" required>
      </div>  
     
      <div class="col-md-12" id="comments-1">
                     <label class="lab-name-1">Country Code*</label>
                     <input type="text" class="form-control" id="f-name-1" placeholder="Enter Category Code" required>
                    <br/>
        </div>
