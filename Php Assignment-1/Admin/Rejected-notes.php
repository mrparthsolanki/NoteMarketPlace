                ...
                <div class="col-md-12">
                    <table class="table table-hover" id="rejected-note-info-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><a href="Note-details.php">Software Engineer</a></td>
                                <td>IT</td>
                                <td>Khayati Patel</td>
                                <td>
                                ...
                                <td>
                                    <div class="action-img">
                                        <div class="action-rejected-note dropleft">
                                            <a id="rejected-note-action-dropdownMenu" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/dots.png" alt="More" class="img-risponsive"></a>
                            ...
                            <tr>
                                <td>2</td>
                                <td><a href="Note-details.php">Computer Basic</a></td>
                                <td>Computer</td>
                                <td>Khayati Patel</td>
                                <td>
                                    <div class="action-img">
