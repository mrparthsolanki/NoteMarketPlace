    ...
    if(isset($_POST['sold_note'])) {
        ...
        <div class='container'>
            ...
            while($row = fetch_array($my_sold_result)) {
                ...
                $select_path_name_sql = "SELECT * FROM seller_notes_attachment WHERE attachment_note_id = $note_id";
                $select_path_name_result = query($select_path_name_sql);
                confirmQuery($select_path_name_result);
                $row_2 = fetch_array($select_path_name_result);
                $attachment_path_name = $row_2['attached_file_name'];
        ...
        <td>
            <div class='action-img'>
                ...
                <div class='mysold-note-action dropleft'>
                    ...
                    <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                        <a class='dropdown-item' href='MySoldNotes-page.php?download_sold_note=$attachment_path&admin_download_note_name=$attachment_path_name'>Download Note</a>
                    </div>
                </div>
            </div>
        </td>
